...
(function ($) {
  ...
  bannerBackgroundColorField.change(function () {
  ...
  bannerActivate.change(function () {
  ...
  removeBannerBackgroundImageButton.click(function () {
  ...
  $('input[type=checkbox]', bannerBackgroundImageRepeatBlock).click(function () {
  ...
  $('.orientation_btn', bannerBackgroundImagePositionBlock).click(function () {
